...
%   \printnames{editor}\addfontfeature{Color=darkgray}\ (dir.)%
	\printnames{author}\addfontfeature{Color=darkgray}%
  \par%
  \newblock%
  {%
    \footnotesize\addfontfeature{Color=darkgray}\itshape%
...
\textsc{url}: \href{http://www.joelgombin.fr}{\url{http://www.joelgombin.fr}}\\
Github : \href{http://www.github.com/joelgombin}{\url{http://www.github.com/joelgombin}}\\[.2cm]
...
Sociologie électorale -- Géographie électorale -- Front national -- Mondes agricoles -- Conspirationnisme -- Inégalités -- Méthodes quantitatives

%%\hrule
\section*{Situation actuelle}
\years{2011-2015} Doctorant en science politique, \textsc{curapp}, Université de Picardie-Jules Verne.
...
\noindent
\years{2010-2011}Chef de projet, association Voiture \& co, Paris\\
...
\section*{Formation}
\noindent
\years{2005-2015}Thèse en cours sur le sujet : \enquote{Éléments pour une sociologie configurationnelle des votes. Les opportunités d’une analyse multiniveau des votes pour le Front
national}, \textsc{Iep} d'Aix-en-Provence puis Université de Picardie-Jules Verne.
...
\section*{Publications}
 ...
 \printbibsection{article}{direction}{Direction de dossier de revue}
 \printbibsection{book}{direction}{Direction d'ouvrage}
 \printbibsection{book}{livre}{Livres}
 \printbibsection{book}{manuel}{Manuels}
 \printbibsectionNK{incollection}{Chapitres d'ouvrage} 
 \printbibsectionNK{inproceedings}{Communications}
 \printbibsectionNK{report}{Rapports et notes de recherche, littérature grise}
...
\begin{minipage}{\linewidth}
 \years{2015-2016}\textbf{Sciences Po Aix}\\
 Chargé d'enseignement\\
 Master 2 Métiers de l'information\\
 \emph{Sociologie électorale}\\
\end{minipage}
...
\begin{minipage}{\linewidth}
 ...
 Chargé d'enseignement\\
 Master 2 Métiers de l'information\\
 \emph{Organisation d'un cycle de conférences en sciences sociales}\\
\end{minipage}


\begin{minipage}{\linewidth}
 \years{2014-2015}\textbf{Université Paris-Ouest}\\
 Chargé d'enseignement\\
 Master 2 Travail politique et parlementaire\\
 \emph{Cartographie électorale}\\
\end{minipage}

\begin{minipage}{\linewidth}
 \years{2013-2015}\textbf{SciencesPo.}\\
 Chargé d'enseignement\\
 Paris School of International Affairs Master Degrees\\
 \emph{Statistical reasoning and quantitative methods}\\
\end{minipage}

\begin{minipage}{\linewidth}
 \years{2013-2015}\textbf{SciencesPo.}\\
 Chargé d'enseignement\\
 \emph{Governing the Large Metropolis} Master Degree\\
 \emph{Open Data -- Open Cities: Open Data for Comparative Urban Research}\\
\end{minipage}
...
\years{2006-2007}Coordination au sein du CSPC du groupe de recherche \enquote{Elections 2007} et animation d'un séminaire méthodologique \enquote{Etudes électorales : méthodes, théories, données} \\

\section*{Logiciels}
Environnements Unix/Linux, et notamment Ubuntu\\
R\\
Stata\\
\LaTeX\\
...
Interventions régulières dans de nombreux médias régionaux, nationaux et internationaux, sur le vote FN et le vote des agriculteurs\\
Diverses conférences \\
Blogging scientifique, avec François Briatte, sur \href{http://politbistro.hypotheses.org}{\url{politbistro.hypotheses.org}}\\
...
\years{2004}Vice-président étudiant du Conseil d'administration de l'\textsc{Iep} d'Aix-en-Provence\\
