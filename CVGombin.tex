...
email: \href{mailto:joel.gombin@u-picardie.fr}{joel.gombin@u-picardie.fr}\\
\textsc{url}: \href{http://www.joelgombin.fr}{http://www.joelgombin.fr}\\ 
\vfill
...
\section*{Publications}
 ...
 \printbibsection{book}{Direction d'ouvrage}
 \printbibsection{incollection}{Chapitres d'ouvrage} 
\printbibsection{inproceedings}{Communications}
\printbibsection{report}{Rapport de recherche}
\printbibsection{thesis}{Travaux universitaires}
...
\years{2010-2011}\textbf{Université Paris-\textsc{1} Panthéon Sorbonne}\\
Chargé d'enseignement\\
Licence 1 de droit\\
\emph{Travaux dirigés \enquote{Introduction à la science politique}}\\
...
Interventions dans de nombreux médias régionaux et nationaux à l'occasion des échéances électorales, sur le vote FN et le vote des agriculteurs\\
...
\years{208-2010}Président de l'association \emph{Les nouvelles Éditions universitaires}, éditrice du \emph{Mensuel de l'Université} et de \url{www.universitemag.fr}\\
